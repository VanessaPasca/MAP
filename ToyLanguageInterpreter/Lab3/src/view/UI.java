...
public class UI {
    ...
    public UI(Controller cont) {
        this.cont = cont;
        this.st=new MyStack<IStmt>();
        this.dict=new MyDictionary<String,Integer>();
    ...
    public void inputExisting(Scanner in) {
        Set<String> options= Stream.of("0","1","2","3").collect(Collectors.toSet());
        String option;
        ...
        IStmt ex1= new CompStmt(new AssignStmt("c",new ConstExpr(2)), new PrintStmt(new
                VarExpr("v")));
        ...
        IStmt ex3 = new CompStmt(new AssignStmt("a", new ArithmExpr(new ConstExpr(2), new
                ...
                new CompStmt(new IfStmt(new VarExpr("a"),new AssignStmt("v",new ConstExpr(2)), new
                        AssignStmt("v", new ConstExpr(3))), new PrintStmt(new VarExpr("c"))));
        System.out.println("Input your option: ");
        option=in.next();
        IStmt chosen;
        while (!options.contains(option)){
